...
execute as @e[type=marker,tag=atimber.marker.leaves] at @s unless block ~ ~ ~ #leaves run kill @s
execute as @e[type=marker,tag=atimber.marker.log] at @s unless block ~ ~ ~ #atimber:logs run kill @s
