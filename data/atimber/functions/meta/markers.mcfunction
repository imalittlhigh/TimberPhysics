...
execute if score atimber.logcount atimber.logcount < atimber.options atimber.max.log at @s[tag=atimber.marker.log,tag=!atimber.marker.log.processed] positioned ~ ~ ~ run function atimber:tree/stem/loop
execute if score atimber.leavescount atimber.leavescount < atimber.options atimber.max.leaves at @s[tag=atimber.marker.log,tag=!atimber.marker.log.processed] positioned ~ ~ ~ run function atimber:tree/stem/leaves/main
execute if score atimber.leavescount atimber.leavescount < atimber.options atimber.max.leaves as @s[tag=atimber.marker.leaves,tag=!atimber.marker.leaves.processed] at @s positioned ~ ~ ~ run function atimber:tree/leaves/loop
